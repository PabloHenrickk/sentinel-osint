...
**Data da Análise:** 2026-04-14 22:02:54
**Gerado por:** Sentinel OSINT v1.0.0-dev | openrouter / nvidia/nemotron-3-super-120b-a12b:free
...
Análise falhou — Todos os providers falharam: OpenRouter falhou e OLLAMA_FALLBACK_MODEL não configurado: OpenRouter retornou 200 sem 'choices': {"error": {"message": "Provider returned error", "code": 524}}
...
| Análise em | 2026-04-14T22:02:54 |
| Arquivo JSON | `data\scanme_nmap_org_20260414_220254_ai_analysis.json` |
| Confidence Score | — |
