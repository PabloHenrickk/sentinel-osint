...
**Data da Análise:** 2026-04-12 17:44:35
...
Análise falhou — Todos os providers falharam: Groq falhou e OLLAMA_FALLBACK_MODEL não configurado: Groq retornou 413: {"error":{"message":"Request too large for model `llama-3.3-70b-versatile` in organization `org_01kmvvynekewq9q0mfjdswf51g` service tier `on_demand` on tokens per minute (TPM): Limit 12000, Requested 14558, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at
...
| Análise em | 2026-04-12T17:44:35 |
| Arquivo JSON | `data\scanme_nmap_org_20260412_174435_ai_analysis.json` |
| Confidence Score | — |
