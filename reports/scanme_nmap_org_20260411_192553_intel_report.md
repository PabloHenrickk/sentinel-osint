...
**Data da Análise:** 2026-04-11 19:25:53
...
Análise falhou — Todos os providers falharam: Groq falhou e OLLAMA_FALLBACK_MODEL não configurado: Groq retornou 429: {"error":{"message":"Rate limit reached for model `llama-3.3-70b-versatile` in organization `org_01kmvvynekewq9q0mfjdswf51g` service tier `on_demand` on tokens per day (TPD): Limit 100000, Used 93127, Requested 19408. Please try again in 3h0m30.24s. Need more tokens? Upgrade to Dev Tier today at htt
...
| Análise em | 2026-04-11T19:25:53 |
| Arquivo JSON | `data\scanme_nmap_org_20260411_192553_ai_analysis.json` |
| Confidence Score | — |
